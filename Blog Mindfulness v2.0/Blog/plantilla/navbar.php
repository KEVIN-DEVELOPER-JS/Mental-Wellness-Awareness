<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li class="<?php echo $active_productos;?>"><a href="../productos/registro_productos.php"> Productos</a></li>
   	...
   	<!--     <li class=""><a href="../sistema/sistema.php"></i> Configuracion</a></li>
        ...
        <li class="<?php //echo $active_productos;?>"><a href="../productos/registro_productos.php"></i> Productos</a></li>
